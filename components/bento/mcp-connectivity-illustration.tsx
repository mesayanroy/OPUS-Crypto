      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Search className="w-full h-full text-muted-foreground bg-popover" />
            </div>
              ...
              >
                ...
                >
                  <img
                    ...
                    className="w-full h-full object-contain opacity-70 grayscale bg-muted" // Apply opacity and grayscale
                  />
                </div>
                <span
                  style={{
