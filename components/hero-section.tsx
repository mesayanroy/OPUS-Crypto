  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <svg
          className="font-serif bg-red-900"
          width="100%"
          height="100%"
      ...
      <Link href="/app">
        <Button className="relative z-10 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 font-mono">
          Launch App
        </Button>
      </Link>
    </section>
